...
export default function loadRom(name: (typeof ROMS)[number]) {
    switch (name) {
        case '15 Puzzle [Roger Ivie] (alt).ch8':
            // @ts-ignore
            return import('data-url:../roms/15 Puzzle [Roger Ivie] (alt).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case '15 Puzzle [Roger Ivie].ch8':
            // @ts-ignore
            return import('data-url:../roms/15 Puzzle [Roger Ivie].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Addition Problems [Paul C. Moews].ch8':
            // @ts-ignore
            return import('data-url:../roms/Addition Problems [Paul C. Moews].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Airplane.ch8':
            // @ts-ignore
            return import('data-url:../roms/Airplane.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Animal Race [Brian Astle].ch8':
            // @ts-ignore
            return import('data-url:../roms/Animal Race [Brian Astle].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Astro Dodge Hires [Revival Studios, 2008].ch8':
            // @ts-ignore
            return import('data-url:../roms/Astro Dodge Hires [Revival Studios, 2008].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Astro Dodge [Revival Studios, 2008].ch8':
            // @ts-ignore
            return import('data-url:../roms/Astro Dodge [Revival Studios, 2008].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'BMP Viewer - Hello (C8 example) [Hap, 2005].ch8':
            // @ts-ignore
            return import('data-url:../roms/BMP Viewer - Hello (C8 example) [Hap, 2005].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Biorhythm [Jef Winsor].ch8':
            // @ts-ignore
            return import('data-url:../roms/Biorhythm [Jef Winsor].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Blinky [Hans Christian Egeberg, 1991].ch8':
            // @ts-ignore
            return import('data-url:../roms/Blinky [Hans Christian Egeberg, 1991].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Blinky [Hans Christian Egeberg] (alt).ch8':
            // @ts-ignore
            return import('data-url:../roms/Blinky [Hans Christian Egeberg] (alt).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Blitz [David Winter].ch8':
            // @ts-ignore
            return import('data-url:../roms/Blitz [David Winter].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Bowling [Gooitzen van der Wal].ch8':
            // @ts-ignore
            return import('data-url:../roms/Bowling [Gooitzen van der Wal].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Breakout (Brix hack) [David Winter, 1997].ch8':
            // @ts-ignore
            return import('data-url:../roms/Breakout (Brix hack) [David Winter, 1997].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Breakout [Carmelo Cortez, 1979].ch8':
            // @ts-ignore
            return import('data-url:../roms/Breakout [Carmelo Cortez, 1979].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Brick (Brix hack, 1990).ch8':
            // @ts-ignore
            return import('data-url:../roms/Brick (Brix hack, 1990).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Brix [Andreas Gustafsson, 1990].ch8':
            // @ts-ignore
            return import('data-url:../roms/Brix [Andreas Gustafsson, 1990].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Cave.ch8':
            // @ts-ignore
            return import('data-url:../roms/Cave.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Chip8 Picture.ch8':
            // @ts-ignore
            return import('data-url:../roms/Chip8 Picture.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Chip8 emulator Logo [Garstyciuks].ch8':
            // @ts-ignore
            return import('data-url:../roms/Chip8 emulator Logo [Garstyciuks].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Clock Program [Bill Fisher, 1981].ch8':
            // @ts-ignore
            return import('data-url:../roms/Clock Program [Bill Fisher, 1981].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Coin Flipping [Carmelo Cortez, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Coin Flipping [Carmelo Cortez, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Connect 4 [David Winter].ch8':
            // @ts-ignore
            return import('data-url:../roms/Connect 4 [David Winter].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Craps [Camerlo Cortez, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Craps [Camerlo Cortez, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Deflection [John Fort].ch8':
            // @ts-ignore
            return import('data-url:../roms/Deflection [John Fort].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Delay Timer Test [Matthew Mikolay, 2010].ch8':
            // @ts-ignore
            return import('data-url:../roms/Delay Timer Test [Matthew Mikolay, 2010].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Division Test [Sergey Naydenov, 2010].ch8':
            // @ts-ignore
            return import('data-url:../roms/Division Test [Sergey Naydenov, 2010].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Figures.ch8':
            // @ts-ignore
            return import('data-url:../roms/Figures.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Filter.ch8':
            // @ts-ignore
            return import('data-url:../roms/Filter.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Fishie [Hap, 2005].ch8':
            // @ts-ignore
            return import('data-url:../roms/Fishie [Hap, 2005].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Framed MK1 [GV Samways, 1980].ch8':
            // @ts-ignore
            return import('data-url:../roms/Framed MK1 [GV Samways, 1980].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Framed MK2 [GV Samways, 1980].ch8':
            // @ts-ignore
            return import('data-url:../roms/Framed MK2 [GV Samways, 1980].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Guess [David Winter] (alt).ch8':
            // @ts-ignore
            return import('data-url:../roms/Guess [David Winter] (alt).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Guess [David Winter].ch8':
            // @ts-ignore
            return import('data-url:../roms/Guess [David Winter].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Hi-Lo [Jef Winsor, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Hi-Lo [Jef Winsor, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Hidden [David Winter, 1996].ch8':
            // @ts-ignore
            return import('data-url:../roms/Hidden [David Winter, 1996].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Hires Maze [David Winter, 199x].ch8':
            // @ts-ignore
            return import('data-url:../roms/Hires Maze [David Winter, 199x].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Hires Particle Demo [zeroZshadow, 2008].ch8':
            // @ts-ignore
            return import('data-url:../roms/Hires Particle Demo [zeroZshadow, 2008].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Hires Sierpinski [Sergey Naydenov, 2010].ch8':
            // @ts-ignore
            return import('data-url:../roms/Hires Sierpinski [Sergey Naydenov, 2010].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Hires Stars [Sergey Naydenov, 2010].ch8':
            // @ts-ignore
            return import('data-url:../roms/Hires Stars [Sergey Naydenov, 2010].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Hires Test [Tom Swan, 1979].ch8':
            // @ts-ignore
            return import('data-url:../roms/Hires Test [Tom Swan, 1979].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Hires Worm V4 [RB-Revival Studios, 2007].ch8':
            // @ts-ignore
            return import('data-url:../roms/Hires Worm V4 [RB-Revival Studios, 2007].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'IBM Logo.ch8':
            // @ts-ignore
            return import('data-url:../roms/IBM Logo.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Jumping X and O [Harry Kleinberg, 1977].ch8':
            // @ts-ignore
            return import('data-url:../roms/Jumping X and O [Harry Kleinberg, 1977].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Kaleidoscope [Joseph Weisbecker, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Kaleidoscope [Joseph Weisbecker, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Keypad Test [Hap, 2006].ch8':
            // @ts-ignore
            return import('data-url:../roms/Keypad Test [Hap, 2006].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Landing.ch8':
            // @ts-ignore
            return import('data-url:../roms/Landing.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Life [GV Samways, 1980].ch8':
            // @ts-ignore
            return import('data-url:../roms/Life [GV Samways, 1980].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Lunar Lander (Udo Pernisz, 1979).ch8':
            // @ts-ignore
            return import('data-url:../roms/Lunar Lander (Udo Pernisz, 1979).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Mastermind FourRow (Robert Lindley, 1978).ch8':
            // @ts-ignore
            return import('data-url:../roms/Mastermind FourRow (Robert Lindley, 1978).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Maze (alt) [David Winter, 199x].ch8':
            // @ts-ignore
            return import('data-url:../roms/Maze (alt) [David Winter, 199x].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Maze [David Winter, 199x].ch8':
            // @ts-ignore
            return import('data-url:../roms/Maze [David Winter, 199x].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Merlin [David Winter].ch8':
            // @ts-ignore
            return import('data-url:../roms/Merlin [David Winter].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Minimal game [Revival Studios, 2007].ch8':
            // @ts-ignore
            return import('data-url:../roms/Minimal game [Revival Studios, 2007].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Missile [David Winter].ch8':
            // @ts-ignore
            return import('data-url:../roms/Missile [David Winter].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Most Dangerous Game [Peter Maruhnic].ch8':
            // @ts-ignore
            return import('data-url:../roms/Most Dangerous Game [Peter Maruhnic].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Nim [Carmelo Cortez, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Nim [Carmelo Cortez, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Paddles.ch8':
            // @ts-ignore
            return import('data-url:../roms/Paddles.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Particle Demo [zeroZshadow, 2008].ch8':
            // @ts-ignore
            return import('data-url:../roms/Particle Demo [zeroZshadow, 2008].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Pong (1 player).ch8':
            // @ts-ignore
            return import('data-url:../roms/Pong (1 player).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Pong (alt).ch8':
            // @ts-ignore
            return import('data-url:../roms/Pong (alt).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Pong 2 (Pong hack) [David Winter, 1997].ch8':
            // @ts-ignore
            return import('data-url:../roms/Pong 2 (Pong hack) [David Winter, 1997].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Pong [Paul Vervalin, 1990].ch8':
            // @ts-ignore
            return import('data-url:../roms/Pong [Paul Vervalin, 1990].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Programmable Spacefighters [Jef Winsor].ch8':
            // @ts-ignore
            return import('data-url:../roms/Programmable Spacefighters [Jef Winsor].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Puzzle.ch8':
            // @ts-ignore
            return import('data-url:../roms/Puzzle.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Random Number Test [Matthew Mikolay, 2010].ch8':
            // @ts-ignore
            return import('data-url:../roms/Random Number Test [Matthew Mikolay, 2010].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Reversi [Philip Baltzer].ch8':
            // @ts-ignore
            return import('data-url:../roms/Reversi [Philip Baltzer].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Rocket Launch [Jonas Lindstedt].ch8':
            // @ts-ignore
            return import('data-url:../roms/Rocket Launch [Jonas Lindstedt].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Rocket Launcher.ch8':
            // @ts-ignore
            return import('data-url:../roms/Rocket Launcher.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Rocket [Joseph Weisbecker, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Rocket [Joseph Weisbecker, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Rush Hour [Hap, 2006] (alt).ch8':
            // @ts-ignore
            return import('data-url:../roms/Rush Hour [Hap, 2006] (alt).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Rush Hour [Hap, 2006].ch8':
            // @ts-ignore
            return import('data-url:../roms/Rush Hour [Hap, 2006].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Russian Roulette [Carmelo Cortez, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Russian Roulette [Carmelo Cortez, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'SQRT Test [Sergey Naydenov, 2010].ch8':
            // @ts-ignore
            return import('data-url:../roms/SQRT Test [Sergey Naydenov, 2010].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Sequence Shoot [Joyce Weisbecker].ch8':
            // @ts-ignore
            return import('data-url:../roms/Sequence Shoot [Joyce Weisbecker].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Shooting Stars [Philip Baltzer, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Shooting Stars [Philip Baltzer, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Sierpinski [Sergey Naydenov, 2010].ch8':
            // @ts-ignore
            return import('data-url:../roms/Sierpinski [Sergey Naydenov, 2010].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Sirpinski [Sergey Naydenov, 2010].ch8':
            // @ts-ignore
            return import('data-url:../roms/Sirpinski [Sergey Naydenov, 2010].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Slide [Joyce Weisbecker].ch8':
            // @ts-ignore
            return import('data-url:../roms/Slide [Joyce Weisbecker].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Soccer.ch8':
            // @ts-ignore
            return import('data-url:../roms/Soccer.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Space Flight.ch8':
            // @ts-ignore
            return import('data-url:../roms/Space Flight.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Space Intercept [Joseph Weisbecker, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Space Intercept [Joseph Weisbecker, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Space Invaders [David Winter] (alt).ch8':
            // @ts-ignore
            return import('data-url:../roms/Space Invaders [David Winter] (alt).ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Space Invaders [David Winter].ch8':
            // @ts-ignore
            return import('data-url:../roms/Space Invaders [David Winter].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Spooky Spot [Joseph Weisbecker, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Spooky Spot [Joseph Weisbecker, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Squash [David Winter].ch8':
            // @ts-ignore
            return import('data-url:../roms/Squash [David Winter].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Stars [Sergey Naydenov, 2010].ch8':
            // @ts-ignore
            return import('data-url:../roms/Stars [Sergey Naydenov, 2010].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Submarine [Carmelo Cortez, 1978].ch8':
            // @ts-ignore
            return import('data-url:../roms/Submarine [Carmelo Cortez, 1978].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Sum Fun [Joyce Weisbecker].ch8':
            // @ts-ignore
            return import('data-url:../roms/Sum Fun [Joyce Weisbecker].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Syzygy [Roy Trevino, 1990].ch8':
            // @ts-ignore
            return import('data-url:../roms/Syzygy [Roy Trevino, 1990].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Tank.ch8':
            // @ts-ignore
            return import('data-url:../roms/Tank.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Tapeworm [JDR, 1999].ch8':
            // @ts-ignore
            return import('data-url:../roms/Tapeworm [JDR, 1999].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Tetris [Fran Dachille, 1991].ch8':
            // @ts-ignore
            return import('data-url:../roms/Tetris [Fran Dachille, 1991].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Tic-Tac-Toe [David Winter].ch8':
            // @ts-ignore
            return import('data-url:../roms/Tic-Tac-Toe [David Winter].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Timebomb.ch8':
            // @ts-ignore
            return import('data-url:../roms/Timebomb.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Trip8 Demo (2008) [Revival Studios].ch8':
            // @ts-ignore
            return import('data-url:../roms/Trip8 Demo (2008) [Revival Studios].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Trip8 Hires Demo (2008) [Revival Studios].ch8':
            // @ts-ignore
            return import('data-url:../roms/Trip8 Hires Demo (2008) [Revival Studios].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Tron.ch8':
            // @ts-ignore
            return import('data-url:../roms/Tron.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'UFO [Lutz V, 1992].ch8':
            // @ts-ignore
            return import('data-url:../roms/UFO [Lutz V, 1992].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Vers [JMN, 1991].ch8':
            // @ts-ignore
            return import('data-url:../roms/Vers [JMN, 1991].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Vertical Brix [Paul Robson, 1996].ch8':
            // @ts-ignore
            return import('data-url:../roms/Vertical Brix [Paul Robson, 1996].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Wall [David Winter].ch8':
            // @ts-ignore
            return import('data-url:../roms/Wall [David Winter].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Wipe Off [Joseph Weisbecker].ch8':
            // @ts-ignore
            return import('data-url:../roms/Wipe Off [Joseph Weisbecker].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Worm V4 [RB-Revival Studios, 2007].ch8':
            // @ts-ignore
            return import('data-url:../roms/Worm V4 [RB-Revival Studios, 2007].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'X-Mirror.ch8':
            // @ts-ignore
            return import('data-url:../roms/X-Mirror.ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'Zero Demo [zeroZshadow, 2007].ch8':
            // @ts-ignore
            return import('data-url:../roms/Zero Demo [zeroZshadow, 2007].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        case 'ZeroPong [zeroZshadow, 2007].ch8':
            // @ts-ignore
            return import('data-url:../roms/ZeroPong [zeroZshadow, 2007].ch8')
                .then(fetch)
                .then(r => r.arrayBuffer())
                .then(b => new Uint8Array(b))
        default:
